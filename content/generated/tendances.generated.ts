 ...
 * main, voir `content/generated/README.md`. Chaque entrée allonge le `statusHistory` d'une
 * tendance déjà déclarée dans `content/tendances.ts`, jamais touché par le pipeline.
 */
